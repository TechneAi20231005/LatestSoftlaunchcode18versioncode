...
export const _apiUrl = "http://3.108.206.34/TSNewBackend/public/api/";
...
export const userSessionData = {
    ...
    Allow_Edit_Authorized_By_Management: sessionStorage.getItem("Allow_Edit_Authorized_By_Management"),
