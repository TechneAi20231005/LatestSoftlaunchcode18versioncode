              ...
              return (
                ...
                >
                  <div className="d-flex ms-3 align-items-center flex-fill">
                    <span
                      className={`avatar lg ${data.bgClass} rounded-circle text-center d-flex align-items-center justify-content-center`}
                    >
                      <i className={data.fileicon}></i>
                    </span>
                  ...
                  <button
                    type="button"
                    className={`btn ${data.bgClass} text-end`}
                  >
                    Download
                  </button>
                </div>
