                ...
                <li className="card mb-2">
                  <div className="card-body">
                    ...
                    <div className="timeline-item-post">
                      ...
                      <p>
                        On the other hand, if the Internet doesn't work on other
                        devices too, then the problem is most likely with the
                        router or the Internet connection itself
                      </p>
                      <div className="mb-2 mt-4">
                        <a className="me-lg-4 me-2 text-primary" href="#!">
                          <i className="icofont-speech-comments"></i> Comment
                          (2)
                        </a>
                      </div>
                      <div>
                        ...
                        <div className="d-flex mt-3 pt-3 border-top">
                          ...
                          <div className="flex-fill ms-3 text-truncate">
                            ...
                            <span className="text-muted">
                              Turn on the modem and one minute later turn on the
                              router. Wait for a few minutes and check”
                            </span>
                          </div>
                        </div>
                      </div>
