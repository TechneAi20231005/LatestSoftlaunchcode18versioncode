                ...
                <div className="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style={{maxWidth: "32rem"}}>
                    <form onSubmit={submitHandler} className="row g-1 p-3 p-md-4">
                        ...
                        <div className="col-12">
                            <div className="mb-2">
                                <label className="form-label"><b>Email address or Contact Number:</b></label>
                            ...
                            <div className="mt-2">
                              ...
                              <input type="text" className="form-control form-control-lg" required name="username" id="username"/>
                            </div>
                            }
                        </div>
                        <div className="col-12 text-center mt-4">
                            <button type="submit" onClick={(e)=>{
                              if(emailCount > 1 && document.getElementById("username").value == ""){
                                alert("This email-id is registered more than "+ emailCount + " times Please enter your Username");
                                e.preventDefault();
                              }
                            }} className="btn btn-lg btn-block btn-light lift text-uppercase">SUBMIT</button>
                        </div>
                        <div className="col-12 text-center mt-4">
                            <span className="text-muted"><Link to={`/${_base}/`} className="text-secondary">Back to Sign in</Link></span>
                        </div>
                    </form>
                </div>
            </div>
