      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            ...
            row.changes.includes("Ticket Created By Department"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            row.changes &&
            row.changes.length > 1 &&
            row.changes.includes("Passing Date"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            row.changes &&
            row.changes.length > 1 &&
            row.changes.includes("Passed Status"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            row.changes &&
            row.changes.length > 1 &&
            row.changes.includes("Passed By"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            row.changes &&
            row.changes.length > 1 &&
            row.changes.includes("Query Type"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
      ...
      conditionalCellStyles: [
        {
          when: (row) =>
            row.changes &&
            row.changes.length > 1 &&
            row.changes.includes("Ticket Type"),
          style: {
            color: "red",
            fontWeight: "bold",
            "&:hover": {
