...
const TicketHistory = ({ match }) => {
  ...
  const columns = [
    ...
    { name: "Ticket Created By User", selector: (row) => row.created_by, sortable: true },
    { name: "Ticket Created By Department", selector: (row) => row.from_department, sortable: true },
    {
    ...
    {
      name: "Assign To User", selector: (row) => row.assign_to_user, sortable: true,
      conditionalCellStyles: [
        {
    ...
    {
      name: "Assign Department", selector: (row) => row.department, sortable: true,
      conditionalCellStyles: [
        {
