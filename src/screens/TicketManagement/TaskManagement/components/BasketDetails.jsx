...
// import { updateBasketDetails } from "../TaskComponentAction";
// import TaskComponentSlice from "../TaskComponentSlice";

// export default function BasketDetails(props) {
//   console.log("props in basket details", props)
//   const [notify, setNotify] = useState();
//   const [user, setUser] = useState();
//   const [todate, setTodate] = useState([]);
//   const [fromdate, setFromdate] = useState([]);
...
//     formData.append("ticket_id", props.ticketId);
//     formData.append("source", "AFTER_TICKET_INSERT");
//     console.log("dd", formData.get("id"))
//     if (formData.get("id")) {
//       dispatch(updateBasketDetails({ id: formData.get("id"), payload: formData }))
//       handleClose()
//       //  props.loadData();
//       //  props.hide();
//       // await new BasketService()
...
//               </div>
//             </div>
//             {console.log("data prop.basketname", props.data.basket_name)}
//             <div className="form-group row">
//               <div className="col-sm-12">
//                 <label className="col-form-label">
//                   <b>
