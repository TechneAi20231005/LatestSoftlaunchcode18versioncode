                ...
                <form method="post" onSubmit={handleForm}>
                    ...
                    <Modal.Body>
                        <table className="table">
                            ...
                            <tbody>
                                {taskOwners && taskOwners.map((d, i) => {
                                    return <tr className="p-0">
                                        <td className="p-1">{i+1}
                                        ...
                                        <td className="p-1">
                                            <div>
                                                <Avatar name={d.taskOwnerName}
                                                    size="30" round={true}
                                                    textSizeRatio={1.2}
                                                    title={d.taskOwnerName}
                                                    key={i}
                                                />
                                                <span style={{marginLeft:'10px'}}>{d.taskOwnerName}</span>
                                            </div>
                                        </td>
                                        <td className="text-center p-1">
                                            ...
                                            <input 
                                                ...
                                                disabled={timerState=="STOP" && d.is_present==1}
                                            />    
                                        </td>
                                    </tr>
                                })}
