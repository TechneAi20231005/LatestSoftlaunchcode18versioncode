    ...
    await new TestCasesService()
      ...
      if(flag == 1){
        ...
        if (document.getElementById('developer_status')) {
          formData.developer_status = document.getElementById('developer_status').value;
        }
                ...
                {data && (
                  <DataTableExtensions {...tableData}>
                    ...
                    />
                        ...
                        <select id="limit_per_page" onChange={e=>{handleFilterAgain(e,"LIMIT")}} className="mx-2">
                        ...
                        <button type="button" onClick={e=>{handleFilterAgain(e,"MINUS")}} className="mx-2"><i className="icofont-arrow-left"></i></button>
                        <button type="button" onClick={e=>{handleFilterAgain(e,"PLUS")}}><i className="icofont-arrow-right"></i></button>
                      </div>
              </div>
            </div>
          </div>
