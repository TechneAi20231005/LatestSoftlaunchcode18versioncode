...
const GetAllTestCases = ({ match, props }) => {
...
test_case_id: temp[key].test_case_id,
  ...
  const selectTestingFunctionRef = useRef();
  ...
  const handleClearData = (e) => {
    ...
    if (selectTestingFunctionRef.current.commonProps.hasValue != null) {
      selectTestingFunctionRef.current.clearValue();
    }
...
dev_status: temp[key].dev_status,
  ...
  const handlePaginationRowChanged = async (e, type)=>{
    ...
    await new TestCasesService()
    .getTestCasesByTicket(useSessionData.userId, ticketId, form)
    .then((res) => {
      if (res.status === 200) {
        if (res.data.status == 1) {
          let counter = 1;
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-2">
                    ...
                    <input
                      ...
                      name="testing_type"
                      key={Math.random()}
                      defaultValue={modalData && modalData.testing_type_name}
                      required
                      disabled
                   />
                  ...
                  <div className="col-sm-2">
                    ...
                    <input
                      ...
                      name="function"
                      key={Math.random()}
                      defaultValue={modalData && modalData.function}
                      required
                      disabled
                    />
...
<div className='col-sm-2'>
                  ...
                  <div className="col-sm-2 mt-2">
                    ...
                    <select
                      ...
                      name="dev_status"
                      defaultValue={
                        modalData ? modalData.tester_status : "dev_status"
                      }
                      // onChange={(e) => colorStyle(e)}
                      key={Math.random()}
                      // style={{ backgroundColor: `${colors}`, color: 'white' }}
                  ...
                  <div className="col-sm-2 mt-2">
                    ...
                    <select
                      ...
                      key={Math.random()}
                      defaultValue={
                        modalData ? modalData.tester_status : "ba_status"
                      }
                      // onChange={(e) => colorStyle(e)}
                      // style={{ backgroundColor: `${colors}`, color: 'white' }}
                      disabled={
