    ...
    return (
      <>
        <div key={props.data.index} className={`${props.data.inputWidth} mt-2`}>
            ...
            <input
              ...
              id={
                props.data.inputName
                  ? props.data.inputName.replace(/ /g, '_').toLowerCase()
                  : ''
              }
          ...
          {props.data.inputType === 'select' &&
            props.data.inputMultiple == true &&
            props.data.inputMandatory == true && (
              <Select
