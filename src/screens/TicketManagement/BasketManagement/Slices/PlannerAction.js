...
import { getTaskPlanner, updateTaskPlanner } from "../../../../services/TicketService/TaskService";

export const UpdatePlannerData = createAsyncThunk(
    "UpdatePlannerData", async(config,thunkapi)=>{
        try{
...
export const getTaskPlannerData = createAsyncThunk(
    "getTaskPlannerData", async(config,thunkapi)=>{
        try{
