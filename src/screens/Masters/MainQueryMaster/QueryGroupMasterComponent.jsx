...
//                 return d.query_type_name.toLowerCase().match(new RegExp(search.toLowerCase(), 'g'))
//             })
//             setData(temp)
//         } else {
//             // setNotify(null)
//             // setNotify({ type: 'danger', message: 'Please Search Department Name' })
//             alert("Please Search Department Name")
//         }
//     }
...
//                         onClick={(e) => {
//                             handleModal({ showModal: true, modalData: row, modalHeader: 'Edit Main Query' })
//                         }}
...
//         await new MainQueryService().getAllMainQuery().then(res => {
//             if (res.status === 200) {
//                 let counter = 1;
...
//                     setQueryType(res.data.data.filter(d => d.is_active === 1));
...
//         // if (!isQueryType(form.getAll('query_type_name'))) {
//         //     flag = 0;
//         //     setNotify({ type: 'danger', message: "Invalid Query Type...." });
//         // }



//         if (!id) {
//             await new MainQueryService().postMainQuery(form).then(res => {
//                 if (res.status === 200) {
//                     if (res.data.status === 1) {
...
//             })
//         } else {
//             await new MainQueryService().updateQueryType(id, form).then(res => {
//                 if (res.status === 200) {
//                     if (res.data.status === 1) {
//                         setModal({ showModal: false, modalData: "", modalHeader: "" });
//                         setNotify({ type: 'success', message: res.data.message });
...
//             <PageHeader headerTitle="Main Query Master" renderRight={() => {
...
//                             <i className="icofont-plus-circle me-2 fs-6"></i>Add Main Query
//                         </button> : ""}
//                 </div>
//             }} />
...
//                                 <div className="col-sm-12">
//                                     <label className="form-label font-weight-bold">Main Query Name : <Astrick color="red" size="13px" /></label>
//                                     <input type="text"
...
//                                 </div>
//                                 <div className="col-sm-12">
//                                     <label className="form-label font-weight-bold">Query Type :</label>
//                                     <Select
//                                         options={QueryTypeDropdown}
//                                         id="form_id"
//                                         name="form_id"
//                                         defaultValue={modal.modalData && QueryTypeDropdown.filter((d) => d.value == modal.modalData.form_id)}
//                                         required={true}
//                                         isMulti
//                                     />
//                                 </div>
...
//                                     <input className="form-check-input" type="hidden" name="is_active" id="is_active_1"
//                                         value="1"
...
//                         </button>
//                         }
//                         {modal.modalData && checkRole && checkRole[13].can_update === 1 ? <button type="submit" className="btn btn-primary text-white" style={{ backgroundColor: "#484C7F" }}  >
//                             Update
//                         </button> : ""}
