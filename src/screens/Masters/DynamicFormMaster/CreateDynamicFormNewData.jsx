              ...
              >
                ...
                <Modal.Body>
                  ...
                  >
                    ...
                    {inputData.map((d, i) => {
                      return (
                        <option value={d.type}>{d.type.toUpperCase()}</option>
                      );
                    })}
                  </select>
                        ...
                        <div className="col-md-3">
                          ...
                          >
                            ...
                            {selectedId &&
                              ...
                              dropdown
                                .filter((d) =>
                                  selectedId.includes(JSON.stringify(d.value))
                                )
                                .map((d, i) => {
                                  return (
                ...
                <Modal.Footer>
                  <button
                    ...
                    onClick={(e) => handleDynamicModal(e, false, null, null)}
                  >
                    Close
                  </button>
                  {showDynamicFormModal.data ? (
                    <button
                      ...
                      onClick={(e) => EditForm(showDynamicFormModal.index)}
                    >
                      Edit From
                    </button>
                  ) : (
                    ...
                    <div className="row">
                      ...
                      >
                        <button
                          ...
                          onClick={(e) =>
                            handleDynamicModal(e, true, null, null)
                          }
                        >
                          Add New Field
                        </button>
