...
import { getAllNotification, getNotification, markedReadNotification } from '../../services/NotificationService/NotificationService'
...
//   }
  ...
  return (
    <div className="container-xxl">
      <PageHeader headerTitle={`Your Approved Notifications (${notifications ? notifications.length : 0})`} />
