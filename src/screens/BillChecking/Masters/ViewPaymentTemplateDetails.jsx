...
import VendorMasterService from '../../../services/Bill Checking/Masters/VendorMasterService';
  ...
  return (
              ...
              <div className="row g-3 mb-3">
                ...
                <div className="col-sm-4">
                  ...
                  >
                    ...
                    <option selected={data && data.payment_type_name == "Monthly"} value="Monthly">Monthly</option>
                    <option selected={data && data.payment_type_name == "Weekly"} value="Weekly">Weekly</option>
                  </select>
                </div>
                <div className="col-sm-4">
                  <label className="form-label font-weight-bold">
    ...
    >
                      ...
                      <option selected={data && data.bill_type_name == "Bill Date"} value="Bill Date">Bill Date</option>
                      <option selected={data && data.bill_type_name == "Received Date"} value="Received Date">Recieved Date</option>
                    </select>
                </div>
              </div>
