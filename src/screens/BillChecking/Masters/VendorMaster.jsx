...
function VendorMaster({ match }) {
    ...
    const uploadPassChequeAttachmentHandler = async (e, type, id = null, attachmentId) => {
        ...
        if (type === "UPLOAD") {
            if ((chequeAttachmentSelectedFiles?.length + (chequeInputRef?.current?.files?.length || 0)) > 2) {
                                    ...
                                    <div className=" col-sm-3 mt-2">
                                        ...
                                        {adharattachment &&
                                            adharattachment.map((attachment, index) => {
                                                const splittedArray = attachment?.path ? attachment?.path?.split('/') : null;
                                                return (
                                                    <div
                                                        key={index}
                                                        ...
                                                        >
                                                            <div className="card-header p-1">
                                                                ...
                                                                <div className="d-flex justify-content-between align-items-center p-0 ">
                                                                    <a
                                                                        href={attachment?.path ? `${_attachmentUrl}/${attachment?.path}` : `${attachment.tempUrl}`}
                                                                        target="_blank"
                                                                        className="btn btn-warning btn-sm p-0 px-1"
                                                                    >
                                                                        <i class="icofont-ui-zoom-out"></i>
                                                                    </a>
                                                                    <span className="fw-6 fw-bold">{attachment?.path ? splittedArray[splittedArray.length - 1] : attachment.fileName}</span>
                                                                    <button
                                                            ...
                                                            <div className="p-1 card-header">
                                                                <div className="d-flex justify-content-between align-items-center p-0">
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        type="button"
                                                                        onClick={(e) => {
                                                                            uploadGstAttachmentHandler(e, "DELETE", index, attachment?.id ? attachment?.id : null);
                                                                        }}
                                                                    >
                                                                        <i
                                                                            class="icofont-ui-delete"
