...
export const postBillcheckingData = createAsyncThunk(
...
export const getUpdatedAuthoritiesData = createAsyncThunk(
...
export const UpdateBillCheckingTransaction = createAsyncThunk(
  'UpdateBillCheckingTransaction',
  async (payload, thunkapi) => {
    try {
      const service = new BillTransactionService();
      const response = await service.updateBillChecking(
        payload.id,
        payload.form
      );
      return response;
...
export const getcreateAuthoritiesData = createAsyncThunk(
...
export const billTypeDataDropDowm = createAsyncThunk(
...
export const statusDropDownData = createAsyncThunk(
  'statusDropDownData',
  async (config, thunkapi) => {
    try {
...
export const mappEmployed = createAsyncThunk(
  'mappEmployed',
  async (config, thunkapi) => {
    try {
      const service = new DropdownService();
...
export const BillcheckingpostData = createAsyncThunk(
...
export const cancelBillCheckData = createAsyncThunk(
  'cancelBillCheckData',
  async (config, thunkapi) => {
    try {
      const service = new BillCheckingTransactionService();
...
export const sectionDropDownData = createAsyncThunk(
  'sectionDropDownData',
  async (config, thunkapi) => {
    try {
      const service = new BillCheckingTransactionService();
