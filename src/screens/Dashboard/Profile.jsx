    ...
    <div className="container-xxl">
      ...
      <div className="row">
        <div className="col-lg-4 mb-4">
          ...
          <div className="card shadow mt-2">
            <div className="card-header bg-primary text-white">
              <h5 className="mb-0">Your Departments</h5> {/* Added mb-0 class to remove margin */}
            </div>
                ...
                <table className="table table-bordered mb-0">
                  ...
                  <tbody>
                    {data &&
                      ...
                      data.department.map((d, i) => (
                        <tr key={i}>
                          <td className="text-center">{i + 1}</td> {/* Center align Sr column */}
            ...
            <div className="card-body">
              <form onSubmit={handleAccountChange} method="post">
                <div className="deadline-form">
                  ...
                  <div className="row mt-2">
                    ...
                    <div className="col-sm-6">
                      ...
                      />
                      {contactError && (
                        <small style={{ color: 'red', right: '45%' }}>{contactError}</small>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row mt-2">
                    <div className="col-sm-6">
                      ...
                      />
                      {whatsappError && (
                        <small style={{ color: 'red', right: '45%' }}>{whatsappError}</small>
                      )}
                    </div>
                ...
                {confirmPasswordError && (
                  <span style={{ color: 'red', position: 'absolute', right: '15%' }}>
