...
export const jobOfferValidation = ({ isSeniorHr }) => {
  return Yup.object().shape({
    ...
    sr_hr_negotiable_salary: isSeniorHr
      ? Yup.number()
          .positive('Negotiable salary from supper admin must be positive')
          .required('Negotiable salary from supper admin is required')
      : Yup.number(),
