...
export const employeeJoiningValidation = Yup.object().shape({
  ...
  relevant_experience: Yup.string().required(
    'Current years of work experience is required'
  ),
  expected_ctc: Yup.number().positive(
    'Expected monthly salary must be positive'
  ),
