  ...
  (function (n) {
    ...
    function T(t) {
      ...
      Kt.__browser ||
        ...
        n.remove()),
        P.extend(t.oBrowser, Kt.__browser),
    ...
    function x(t, e) {
      ...
      t.aoColumns.push(n),
        ((n = t.aoPreSearchCols)[r] = P.extend({}, Kt.models.oSearch, n[r])),
        C(t, r, P(e).data());
    }
    function C(t, e, n) {
      e = t.aoColumns[e];
    ...
    function t(t) {
      ...
      return (
        ...
        null === (e = Kt.ext.legacy.ajax) ? (t.sAjaxSource ? s : d) : e ? s : d
      );
    }
    function o(t, n) {
      var e = function (t, e) {
    ...
    function J(t) {
      for (
        var e, n, r = Kt.ext.search, a = t.aiDisplay, o = 0, i = r.length;
        o < i;
        o++
      ) {
    ...
    function It(t, e) {
      ...
      for (
        var o,
          i = Kt.ext.type.order[r.sType + '-pre'],
          s = 0,
          l = t.aoData.length;
        s < l;
        s++
    ...
    function Mt(t, e) {
      ...
      return (
        e <= n
          ? (t = Yt(0, e))
          : t <= r
          ? ((t = Yt(0, n - 2)).push('ellipsis'), t.push(e - 1))
          : (e - 1 - r <= t
              ? (t = Yt(e - (n - 2), e))
              : ((t = Yt(t - r + 2, t + r - 1)).push('ellipsis'),
                t.push(e - 1)),
    ...
    function Wt(n) {
      P.each(
        ...
        function (t, e) {
          (Gt.type.order[t + n + '-pre'] = e),
            t.match(/^html\-/) && (Gt.type.search[t + n] = Gt.type.search.html);
        }
      );
    }
    function e(e) {
      return function () {
        var t = [Lt(this[Kt.ext.iApiIndex])].concat(
    ...
    function qt(t, e, n) {
      return (
        !!Bt(t) ||
        ((Bt(t) || 'string' == typeof t) && !!Xt(t.replace(ne, ''), e, n)) ||
        null
      );
    }
    function zt(t, e, n, r) {
    ...
    var Gt,
      ...
      Kt = function (b) {
        ...
        var t,
          ...
          y = this.length;
        for (t in (v && (b = {}),
        (this.oApi = this.internal = Gt.internal),
        Kt.ext.internal))
          t && (this[t] = e(t));
        return (
          this.each(function () {
            ...
            if ('table' != this.nodeName.toLowerCase())
              ...
              (null !== t && '' !== t) ||
                (this.id = t = 'DataTables_Table_' + Kt.ext._unique++);
              ...
              (u.nTable = this),
                ...
                T(u);
              var d = u.oClasses;
              P.extend(d, Kt.ext.classes, n.oClasses),
                o.addClass(d.sTable),
    ...
    var xe = function (t, e) {
      ...
      if (((e = e.page), 'ssp' == Ht(t)))
        return 'removed' === o ? [] : Yt(0, a.length);
      if ('current' == e)
    ...
    Zt('cells()', function (g, t, b) {
      ...
      (Kt.versionCheck = Kt.fnVersionCheck =
        function (t) {
          for (
            var e,
              n,
      ...
      (Kt.isDataTable = Kt.fnIsDataTable =
        function (t) {
          var r = P(t).get(0),
            a = !1;
          return (
            t instanceof Kt.Api ||
            (P.each(Kt.settings, function (t, e) {
        ...
        return (
          ...
          this.iterator('table', function (e) {
            ...
            (e.bDestroying = !0),
              ...
              -1 !== (t = P.inArray(e, Kt.settings)) &&
                Kt.settings.splice(t, 1);
          })
        );
      }),
      ...
      (Kt.defaults = {
        ...
        fnStateLoadCallback: function (t) {
          try {
            return JSON.parse(
              (-1 === t.iStateDuration ? localStorage : localStorage).getItem(
        ...
        fnStateSaveCallback: function (t, e) {
          try {
            (-1 === t.iStateDuration ? localStorage : localStorage).setItem(
              'DataTables_' + t.sInstance + '_' + location.pathname,
              JSON.stringify(e)
            );
          } catch (t) {}
    ...
    P.extend(Fe, {
          ...
          _: function (l, t, c, e, u, d) {
            var f,
              ...
              v = function (t, e) {
                ...
                for (
                  var r = p.sPageButtonDisabled, a = 0, o = e.length;
                  a < o;
                  a++
                ) {
                  var i = e[a];
      ...
      P.extend(Kt.ext.type.detect, [
        function (t, e) {
          return (e = e.oLanguage.sDecimal), Xt(t, e) ? 'num' + e : null;
        },
        function (t, e) {
          return (!t || t instanceof Date || re.test(t)) &&
        ...
        function (t, e) {
          return (
            (e = e.oLanguage.sDecimal), Xt(t, e, !0) ? 'num-fmt' + e : null
          );
        },
        function (t, e) {
        ...
        function (t, e) {
          return (
            (e = e.oLanguage.sDecimal), qt(t, e, !0) ? 'html-num-fmt' + e : null
          );
        },
        function (t, e) {
    ...
    return (
      ...
      (((P.fn.dataTable = Kt).$ = P).fn.dataTableSettings = Kt.settings),
      (P.fn.dataTableExt = Kt.ext),
    ...
    d.extend(n.prototype, {
      ...
      _classLogic: function () {
        ...
        function s(t, e, n, r) {
          if (n) {
            if ('max-' === n)
              for (r = o._find(e).width, e = 0, n = l.length; e < n; e++)
                l[e].width <= r && a(t, l[e].name);
            else if ('min-' === n)
              for (r = o._find(e).width, e = 0, n = l.length; e < n; e++)
                l[e].width >= r && a(t, l[e].name);
            else if ('not-' === n)
              for (e = 0, n = l.length; e < n; e++)
                -1 === l[e].name.indexOf(r) && a(t, l[e].name);
